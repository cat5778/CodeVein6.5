...
{
private:
	explicit CEffect(LPDIRECT3DDEVICE9 pGraphicDev,wstring wstrTexName,  wstring wstrAlphaTexName,_vec3 vPos);
...
public:
	...
	static CEffect*		Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrTexName, wstring wstrAlphaTexName, _vec3 vPos);
