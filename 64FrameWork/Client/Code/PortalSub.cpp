...
CPortalSub::CPortalSub(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrTexName, _float fLength, _float fRotY, _bool bIsRight ,UISTATE eUIState)
	:C3DUI(pGraphicDev,wstrTexName,fLength,fRotY,bIsRight,eUIState)
{
	m_wstrInstName = L"PortalSub_UI";
}

CPortalSub::~CPortalSub(void)
{

}

HRESULT CPortalSub::Ready_GameObject(void)
{
...
HRESULT CPortalSub::LateReady_GameObject(void)
{
...
_int CPortalSub::Update_GameObject(const _float& fTimeDelta)
{
	if (!m_bIsOn)
		return 0;
	m_fGap = 0.45f;
...
void CPortalSub::Render_GameObject(void)
{
...
HRESULT CPortalSub::Add_Component(void)
{
...
HRESULT CPortalSub::SetUp_ConstantTable(LPD3DXEFFECT& pEffect)
{
...
wstring CPortalSub::Get_ItemName()
{
	wstring wstrItem;
...
CPortalSub* CPortalSub::Create(LPDIRECT3DDEVICE9 pGraphicDev, wstring wstrTexName, _float fLength, _float fRotY, _bool bIsLeft, UISTATE eUIState)
{
	CPortalSub*	pInstance = new CPortalSub(pGraphicDev, wstrTexName, fLength,fRotY,bIsLeft, eUIState);
